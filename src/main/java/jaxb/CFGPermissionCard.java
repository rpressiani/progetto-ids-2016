 ...
 *       &lt;sequence>
 *         &lt;element name="cities" type="{urn:co4}CFGCities" maxOccurs="unbounded"/>
...
public class CFGPermissionCard {
    ...
    protected List<CFGCities> cities;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<CFGCities> getCities() {
        if (cities == null) {
            cities = new ArrayList<CFGCities>();
        }
        return this.cities;
    }
